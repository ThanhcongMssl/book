...
/*global define*/
define (
    ['jquery', 'underscore', 'backbone', 'facade', 'text!templates/mobile/header/toolbar/base.html', './text/main', 'events'],
    function($, _, Backbone, facade, baseTemplate,TextTool, Events){
